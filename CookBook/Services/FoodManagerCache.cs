...
namespace CookBook.Services
{
    public class FoodManagerCache
    {
        ...
        public FoodManagerCache(IIngredientsRepository ingredientsRepository, IRecipeRepository recipesRepository, IRecipeIngredientsRepository recipeIngredientsRepository)
        {
        ...
        public void ClassifyRecipes()
        {
            ...
            foreach(var recipeGroup in groupedRecipesAndIngredients)
            {
                ...
                if (isRecipeAvailable) { AvailableRecipes.Add(recipeToAdd); } else { UnavailableRecipes.Add(recipeToAdd); }
            }
